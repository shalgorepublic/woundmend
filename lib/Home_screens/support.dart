                ...
                children: <Widget>[
                  GestureDetector(
                    child: Row(children: <Widget>[
                      Container(
                        padding: EdgeInsets.only(left: 3) , child: Image.asset(
                        'assets/art.png' ,
                        width: 22 ,
                        height: 22 ,
                      ) ,) ,
        ...
        showDialog<dynamic>(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text(successInformation['message'],style: TextStyle(fontFamily: 'Reguler'),),
              actions: <Widget>[
                FlatButton(
                  child: Text('Okey'),
                  onPressed: () {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          FileImage != null ?
          Image.file(FileImage , height: 200 , width: 200 ,) :
          Container(),
    ScopedModelDescendant<MainModel>(
    builder: (BuildContext context, Widget child, MainModel model) {
    return model.supportMessageLoading?
      AlertDialog(
          content:Row(children: <Widget>[CircularProgressIndicator(),SizedBox(width: 20,), Text("Please wait"),],)
